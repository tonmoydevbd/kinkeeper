    ...
    <div className="max-w-277.5 mx-auto grid grid-cols-1 md:grid-cols-3 py-5 md:py-20 gap-6">
      <div className="col-span-1">
        ...
        <div className="flex flex-col justify-center items-center gap-4">
          <button className="bg-white flex justify-center items-center py-4 w-full gap-2 text-xl shadow-md border border-gray-100"><HiOutlineBellSnooze />Snooze 2 weeks</button>
          <button className="bg-white flex justify-center items-center py-4 w-full gap-2 text-xl shadow-md border border-gray-100"><LuArchive />Archive</button>
      ...
      <div className="col-span-1 md:col-span-2 flex flex-col py-4 gap-6">
        ...
        <div className="bg-white flex justify-between shadow-md border border-gray-100 py-8 gap-4 p-8">
          <div>
